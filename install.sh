...
kubectl logs -l app=fastapi --all-containers --previous -n standard > yaml-standard/logs-fastapi.txt
kubectl logs -l app=pgadmin --all-containers --previous -n standard > yaml-standard/logs-pgadmin.txt
kubectl logs -l app=postgres --all-containers --previous -n standard > yaml-standard/logs-postgres.txt
